module.exports = function (app, model) {
    app.post("/api/temp/user", createUser);
    app.get("/api/temp/user", findUsers);
    app.get("/api/temp/user/:id", findUserById);
    //to comment out here
    app.get("/api/temp/user?username=username", findUserByUsername);
    app.get("/api/temp/user?username=username&password=password", findAlice);
    //end
    app.put("/api/temp/user/:id", updateUser);
    app.delete("/api/temp/user/:id", deleteUser);
    app.post("/api/temp/user/:userid/userJoinGroup", joinedGroups);
    app.post("/api/temp/user/:userid/userLikeGroup", userLikeGroup);
